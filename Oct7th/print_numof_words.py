"""Program to print number of words in a given list of strings"""


def print_num_words(inputs):
    """This function takes arguments from the function main"""
    lists = inputs.split()
