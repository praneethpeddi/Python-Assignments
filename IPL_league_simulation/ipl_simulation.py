...
def playoff_matches(playoff_teams):
    ...
    print(f"Team won in the playoff3, Finalist2                     : {playoff3}")
    return playoff1, playoff3


def final_match(finalist1, finalist2):
    winner = random.choice((finalist1, finalist2))
    print(f"Congrats to " + colored("\033[1m" + f'{winner}' + "\033[0m", 'green') + " for winning the IPL")
    # print(colored("\033[1m" + f'{winner}' + "\033[0m" , 'green'))
...
def main():
    ...
    final_match(finalist1, finalist2)
